...
function ensureSampleImages() {
  try {
    ...
    const fromUploads = fs.readdirSync(uploadsDir)
...
const seed = async () => {
  ...
  console.log('Citizen:    citizen@fixmycity.com / password123');
  console.log('Contractor: contractor@fixmycity.com / password123');
  console.log('Municipal:  municipal@fixmycity.com / password123');
  console.log('\nSample complaints:');
  console.log('FM-2026-0001 - VERIFIED (score: 93) - EEH -> PWD Division, Thane');
  console.log('FM-2026-0002 - MANUAL_REVIEW (score: 69) - Ghodbunder Rd -> TMC');
  console.log('FM-2026-0003 - REJECTED (score: 15) - Pokhran Rd -> TMC');
  console.log('FM-2026-0004 - REPORTED (new) - Thane Station Rd -> TMC');
  console.log('FM-2026-0005 - UNDER_REPAIR - Kolshet Rd (critical) -> PWD Division, Thane');
